...
import{Loginpageindsalgo} from './Loginpage';
import{Datastructureindsalgo} from './Datastructurepage';
import{Arrayindsalgo} from './Arraypage';
import {Linkedindsalgo} from './LinkedList';
import {AccessTreeTopics} from './AccessTreeTopics'
import {AccessQueueTopics} from './AccessQueueTopics'
import { Stackindsalgo } from './Stackpage'
import{ Graphindsalgo } from './Graphpage'*/
const { test, expect } = require('@playwright/test');
const { Loginpageindsalgo } = require('./Loginpage');
const { Datastructureindsalgo } = require('./Datastructurepage');
const { Arrayindsalgo } = require('./Arraypage');
const { Linkedindsalgo } = require('./LinkedList');
const { AccessTreeTopics } = require('./AccessTreeTopics');
const { AccessQueueTopics } = require('./AccessQueueTopics');
const { Stackindsalgo } = require('./Stackpage');
const { Graphindsalgo } = require('./Graphpage');
